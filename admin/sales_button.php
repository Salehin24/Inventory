<!-- Delete Product -->
    <div class="modal fade" id="del_<?php echo $pid; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<?php
						$a=mysqli_query($conn,"select * from sales_report where saleid='$saleid'");
						$b=mysqli_fetch_array($a);
					?>
                    <h5><center>Bill Reff: <strong><?php echo $b['bill_reff']; ?></strong></center></h5>
					<form role="form" method="POST" action="delete_report.php<?php echo '?id='.$saleid; ?>">
                </div>                 
				</div>
